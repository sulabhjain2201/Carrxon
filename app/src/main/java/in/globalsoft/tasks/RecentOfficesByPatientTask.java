...
public class RecentOfficesByPatientTask extends AsyncTask<Void, Void, Void> {
    ...
    ProgressDialog pd;
    AppPreferences pref;
    public RecentOfficesByPatientTask(Context con)
    {
        this.con=con;
    ...
    protected Void doInBackground(Void... arg0) {
        // TODO Auto-generated method stub
        String url="http://carrxon.com/CarrxonWebServices/ws/office_recent_chat.php?user_id="+pref.getUserId()+"&status=patient";
    ...
    protected void onPostExecute(Void result)
    {
        ...
        if(response!=null)
        {
            pref.saveRecentOfficeChat(response);
