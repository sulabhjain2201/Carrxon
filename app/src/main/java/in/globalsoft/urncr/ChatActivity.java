...

{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(pref.getLogintype()==1)
		{
			...
			{*/
			url="http://carrxon.com/CarrxonWebServices/ws/getChat.php?user_id="+pref.getDoctorId()+"&friend_id="+msgPatient.getPatient_id();
			//}
		...
		else
		{
			...
			url="http://carrxon.com/CarrxonWebServices/ws/getChat.php?user_id="+pref.getUserId()+"&friend_id="+msg.getDoctor_id();
			...
			public void onClick(View arg0) {
				...
				if(!etMessage.getText().toString().equals(""))
				{
					...
					if(pref.getLogintype()==1)
					{
						...
						url="http://carrxon.com/CarrxonWebServices/ws/sendchat.php?user_id="+pref.getDoctorId()+"&friend_id="+msgPatient.getPatient_id()+"&chat="+etMessage.getText().toString()+"&conv_id="+conv_id+"&status=doctor&chat_time="+Cons.convertDateToString(new Date(), "yyyy-MM-dd HH:mm:ss");
					...
					else
					{
						...
						url="http://carrxon.com/CarrxonWebServices/ws/sendchat.php?user_id="+pref.getUserId()+"&friend_id="+msg.getDoctor_id()+"&chat="+etMessage.getText().toString()+"&conv_id="+conv_id+"&status=patient&chat_time="+Cons.convertDateToString(new Date(), "yyyy-MM-dd HH:mm:ss");
					}
